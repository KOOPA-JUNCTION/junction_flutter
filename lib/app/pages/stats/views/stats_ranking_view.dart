        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          height: 40,
                          child: Image.network(
                              "http://59.1.4.101:3000/files/${controller.rank.value['data'][index]["imageFileName"]}"),
                        ),
                        const SizedBox(width: 12),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(controller.rank.value['data'][index]['name']),
              ...
              childCount: (controller.rank.value["data"] as List).length,
            ),
          ),
        ],
      ),
